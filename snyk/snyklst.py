...
class Crawl():
    def __init__(self):
        ...
        self.lst = ["cargo", "cocoapods", "composer", "golang", "hex", "maven", "npm", "nuget", "pip", "rubygems", "swift", "unmanaged", "alpine", "amzn", "centos", "debian", "oracle", "rhel", "rocky", "sles", "ubuntu"]
    ...
    def spider(self):
        ...
        for v in self.lst:
            for i in range(1, 31):
                if i % 20 == 0:
                    print(i)
                res = requests.get(self.url + v + '/' + str(i))
